...
export const THEME_PRESETS: Record<string, {
  ...
  orange: {
    name: "Cam cháy & Xanh lục bảo (Đất nung & Thảo mộc)",
    primary50: "#fff7ed",
    primary100: "#ffedd5",
    primary600: "#ea580c",
    primary700: "#c2410c",
  ...
  navy: {
    name: "Xanh cổ điển Navy & Cát vàng (Uy tín & Đẳng cấp)",
    primary50: "#f0f4f8",
    primary100: "#d9e2ec",
    primary600: "#1b365d",
    primary700: "#122646",
  ...
  indigo: {
    name: "Xanh chàm & Đào ấm (Indigo & Warm Peach)",
    primary50: "#f5f3ff",
    primary100: "#ede9fe",
    primary600: "#4f46e5",
    primary700: "#4338ca",
  ...
  rose: {
    name: "Hồng tro khô & Đất than (Dusty Rose & Slate)",
    primary50: "#fff1f2",
    primary100: "#ffe4e6",
    primary600: "#e11d48",
    primary700: "#be123c",
  ...
  cyan: {
    name: "Xanh đại dương & San hô (Ocean Cyan & Coral)",
    primary50: "#ecfeff",
    primary100: "#cffafe",
    primary600: "#0891b2",
    primary700: "#0e7490",
  ...
  forest: {
    name: "Xanh rừng già & Vàng mật ong (Forest & Honey)",
    primary50: "#f0fdf4",
    primary100: "#dcfce7",
    primary600: "#059669",
    primary700: "#047857",
